...
func TestWithJSONFormat_Fail(t *testing.T) {
	testCases := []struct {
		name           string
		modifyConfig   func(*logger.LoggerConfig)
		expectedFormat string
	}{
		{
			"Overwrite Existing Format",
			func(cfg *logger.LoggerConfig) { cfg.Format = "text" },
			"json",
		},
	}
